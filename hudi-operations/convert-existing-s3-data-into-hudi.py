#convert existing data in s3 (json) to apache hudi format.
# In glue visual ETL workflow -
    # Choose source as s3 and provide s3 patth where we have json data
    # Goto marketplace and add the hudi connection.
    # rename id field to pk
    # choose the target as hudi and select the hudi connection name
    # and below is the optimized code after above all.
